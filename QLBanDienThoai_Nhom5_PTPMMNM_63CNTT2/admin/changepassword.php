            ...
            <form action="" method="post">
                <fieldset>
                    ...
                    <div class="form-group form-group-default">
                        ...
                        <input class="form-control" placeholder="Mật khẩu" name="current_password" type="password" value="" />
                    </div>
                    <div class="form-group form-group-default">
                        <label>Mật khẩu mới <span class="text-danger">*</span></label>
                        <input class="form-control" placeholder="Mật khẩu mới" name="new_pass" type="text" autofocus />
                    </div>
                    <div class="form-group form-group-default">
                        <label>Xác nhận mật khẩu mới</label><span class="text-danger">*</span>
                        <input class="form-control" placeholder="Xác nhận mật khẩu mới" name="confirm_pass" type="text" autofocus />
                    </div>
