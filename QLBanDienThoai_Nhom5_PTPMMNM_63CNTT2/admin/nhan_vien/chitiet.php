            ...
            <div class="page-inner">
                <div class="page-header">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Chi tiết thông tin nhân viên: <?php echo $nhanVien['hoTen'] ?? 'Không xác định';?></h4>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="<?php echo $base_url ?>/admin/nhan_vien/hienthi.php" class="btn btn-danger">Quay lại</a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
